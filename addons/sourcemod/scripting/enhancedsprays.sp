...
{
	name = "Enhanced Sprays Dead Sprays",
	author = "ReFlexPoison",
...
{
	CreateConVar("sm_enhancedsprays_version", PLUGIN_VERSION, PLUGIN_VERSION, FCVAR_PLUGIN | FCVAR_SPONLY | FCVAR_DONTRECORD | FCVAR_NOTIFY);
