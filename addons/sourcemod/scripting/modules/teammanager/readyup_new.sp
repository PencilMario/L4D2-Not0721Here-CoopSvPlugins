...
public OnPluginStart() {
	...
	RegConsoleCmd("unlockdoor", CMD_UnlockDoor);
...
public Action:CMD_UnlockDoor(client, args) {
	if (!b_IsReadyUp && !b_IsExitedStartArea) ToggleSaferoomDoor(true);
