...
#define HeadShot_Sound "ui/littlereward.wav"
#define VOLUME 1.0
// Convar
ConVar g_hEnable;
...
public void OnPluginStart()
{
	...
	// Create ConVar
	g_hEnable = CreateConVar("sound_enable", "0", "是否启用击杀提示音：0 = 关闭， 1 = 启用", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	g_hOtherEnable = CreateConVar("other_sound", "1", "当小ss或特感死于土制炸弹爆炸或燃烧瓶时，是否启用击杀提示音：0 = 关闭， 1 = 启用", FCVAR_NOTIFY, true, 0.0, true, 1.0);
...
{
	EmitSoundToClient(m_client, HeadShot_Sound, _, SNDCHAN_AUTO, SNDLEVEL_CONVO, _, VOLUME);
