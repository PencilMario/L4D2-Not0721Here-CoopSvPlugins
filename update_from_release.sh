...
for dir in "${directories[@]}"; do
    if [ -d "$dir" ]; then
        ...
        mkdir -p "$dir/addons/sourcemod/configs" "$dir/addons/sourcemod/data" "$dir/addons/sourcemod/gamedata" "$dir/addons/sourcemod/plugins" "$dir/addons/sourcemod/translations" "$dir/scripts" "$dir/cfg"
