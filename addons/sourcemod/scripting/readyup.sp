...
int botsToSkip = 0;
new bool:deleteSaferoomDoorOnStart;
new String:doorAngles[64];
new String:doorAxis[64];
...
new Handle:StructuresToBuild_Models;
new Handle:StructuresToBuild_Angles;
new Handle:StructuresToBuild_Axis;
new Handle:StructuresToBuild_Delete;
new Handle:StructuresToDelete;
new Handle:StructuresToDelete_Names;
new Handle:StructuresToDelete_Class;
...
public OnConfigsExecuted() {
	...
	decl String:sStructures[PLATFORM_MAX_PATH];
...
stock void buildCustomStructures() {
	...
	for (int i = 0; i < size; i++) {
		...
		new Float:origin[3];
		new String:sOrigin[3][10];
		ExplodeString(sAxis, " ", sOrigin, 3, 10);
		origin[0] = StringToFloat(sOrigin[0]);
		origin[1] = StringToFloat(sOrigin[1]);
		origin[2] = StringToFloat(sOrigin[2]);
		new Float:angles[3];
		new String:sAngles[3][10];
