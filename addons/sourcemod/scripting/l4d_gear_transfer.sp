...
public void OnPluginStart()
{
	...
	g_hCvarMethod =			CreateConVar(	"l4d_gear_transfer_method",			"2",			"0=Off. 1=Shove only, 2=Reload key only, 3=Shove and Reload key to transfer items.", CVAR_FLAGS);
	...
	g_hCvarNotify =			CreateConVar(	"l4d_gear_transfer_notify",			"12",			"0=Off, 1=Display transfers to everyone, 2=Also display when transferring pills/adrenaline via the games own system, 4=Display between recipients only. 8=Ignore printing pills/adrenaline and use game prompt only. Add numbers together.", CVAR_FLAGS);
	...
	g_hCvarTimerGive =		CreateConVar(	"l4d_gear_transfer_timer_give",		"0.0",			"0.0=Off. How often to check survivor bot positions to real clients for auto give.", CVAR_FLAGS, true, 0.0, true, 10.0);
	g_hCvarTimerGrab =		CreateConVar(	"l4d_gear_transfer_timer_grab",		"0.0",			"0.0=Off. How often to check survivor bot positions to item positions for auto grab.", CVAR_FLAGS, true, 0.0, true, 10.0);
